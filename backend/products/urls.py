...
urlpatterns = [
    ...
    path('shops/init-card-setup/', ShopViewSet.as_view({'post': 'init_card_setup'}), name='shop-init-card-setup'),
    path('shops/complete-card-setup/', ShopViewSet.as_view({'post': 'complete_card_setup'}), name='shop-complete-card-setup'),
