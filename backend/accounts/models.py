...
class CustomUserManager(BaseUserManager):
    def create_user(self, email, user_type="seller", password=None, first_name=None, last_name=None, **extra_fields):
        if not email:
...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    REQUIRED_FIELDS = []  # No longer require first_name, last_name, etc.
