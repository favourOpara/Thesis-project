...
const KnowledgeBase = () => (
  <div style={{ minHeight: "100vh", background: "#fff", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
    ...
    {/* ── Premium Stores: Buyer Education ── */}
    <section style={{ maxWidth: "900px", margin: "0 auto", padding: "72px 24px 0" }}>
      <div style={{ textAlign: "center", marginBottom: "40px" }}>
        ...
        <h2 style={{ fontSize: "clamp(24px, 3.5vw, 34px)", fontWeight: 600, color: "#0f172a", margin: "0 0 14px", letterSpacing: "-0.3px" }}>
          What makes a store premium?
        </h2>
        <p style={{ fontSize: "15px", color: "#64748b", maxWidth: "520px", margin: "0 auto", lineHeight: 1.7 }}>
          Premium stores on Abatrades are verified sellers who have enrolled in our full-service fulfilment programme.
          When you shop from one, you're getting more than a product — you're getting a guaranteed experience.
        </p>
      </div>
        ...
        {[
          {
            ...
            body: "Every premium store has been reviewed and approved by Abatrades. You know exactly who you're buying from.",
            color: "#16a34a", bg: "#f0fdf4",
          },
          {
            icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="3" width="15" height="13" rx="1"/><path d="M16 8h4l3 4v4h-7V8z"/><circle cx="5.5" cy="18.5" r="2.5"/><circle cx="18.5" cy="18.5" r="2.5"/></svg>,
            title: "Faster, reliable delivery",
            body: "Stock is already stored in our warehouse. When you order, we pack and ship it ourselves — no waiting on the seller to do it.",
            color: "#2563eb", bg: "#eff6ff",
          },
          {
            icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 7H4a2 2 0 0 0-2 2v6a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V9a2 2 0 0 0-2-2z"/><path d="M16 21V5a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/></svg>,
            title: "Inventory we can vouch for",
            body: "Products from premium stores pass through our warehouse. We've physically handled them — no mystery packages.",
            color: "#7c3aed", bg: "#f5f3ff",
          },
          {
            icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>,
            title: "Direct seller communication",
            body: "Have a question before you buy? Message the store directly. Premium sellers are expected to respond promptly.",
          ...
          },
          {
            ...
            title: "Premium badge on every product",
            body: "Premium store listings are clearly marked so you always know when you're getting the full Abatrades-backed experience.",
            color: "#b45309", bg: "#fffbeb",
          },
          {
            icon: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>,
            title: "Backed by Abatrades",
            body: "If something goes wrong with a premium order, we're accountable. Our team is involved from listing to delivery.",
            color: "#dc2626", bg: "#fef2f2",
          },
        ].map(({ icon, title, body, color, bg }) => (
          <div key={title} style={{ background: "#fff", borderRadius: "14px", border: "1px solid #e2e8f0", padding: "24px" }}>
            <div style={{ width: "40px", height: "40px", borderRadius: "10px", background: bg, color, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: "14px" }}>{icon}</div>
            <h3 style={{ fontSize: "14.5px", fontWeight: 600, color: "#0f172a", margin: "0 0 8px" }}>{title}</h3>
            <p style={{ fontSize: "13px", color: "#64748b", lineHeight: 1.65, margin: 0 }}>{body}</p>
          </div>
        ))}
      ...
      {/* How to spot a premium store */}
      <div style={{
        background: "linear-gradient(135deg, #fffbeb 0%, #fef3c7 100%)",
        border: "1.5px solid #fde68a", borderRadius: "16px",
        padding: "32px 28px", display: "flex", gap: "20px", alignItems: "flex-start", flexWrap: "wrap",
        marginBottom: "72px",
      }}>
        <div style={{ width: "44px", height: "44px", borderRadius: "10px", background: "#fef9c3", color: "#92400e", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
          <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2"/>
          </svg>
        </div>
        <div style={{ flex: 1, minWidth: "200px" }}>
          <h3 style={{ fontSize: "15px", fontWeight: 700, color: "#78350f", margin: "0 0 8px" }}>
            How to spot a premium store
          </h3>
          <p style={{ fontSize: "13.5px", color: "#92400e", lineHeight: 1.7, margin: "0 0 14px" }}>
            Look for the <strong>gold star badge</strong> on a store's profile or product listings. It means the seller is premium-verified and their stock is handled by Abatrades from our warehouse.
            You'll also see a <strong>"Fulfilled by Abatrades"</strong> label on eligible products, giving you full confidence in the delivery process.
          </p>
          <p style={{ fontSize: "12px", color: "#a16207", margin: 0, fontStyle: "italic" }}>
            Not all stores are premium — standard sellers manage their own storage and shipping. Premium stores are clearly labelled throughout the platform.
          </p>
        </div>
      </div>
    </section>
