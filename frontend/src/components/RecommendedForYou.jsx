...
const API_URL = "inspiring-spontaneity-production.up.railway.app/api/recommended-for-you/";
const PRODUCT_DETAIL_URL = (id) => `inspiring-spontaneity-production.up.railway.app/api/products/${id}/`;
